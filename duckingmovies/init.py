...
def create_initial_data(request):
 ...
 #Directores
  ...
  #Películas
  movieEndgame = Movie(name="Endgame", rating=5.0, budget=3.5, duration=180.0, classification="PG-13", director= directorAnthony, producer=movieProducerMarvel, imageUrl="https://static.claro.com.pe/img/otros/avengersv1.jpg")
  movieEndgame.save()
  ...
  #Series
  serieFriends = Serie(name="Friends", rating=5.0, seasons=10, classification="TV-14", director=directorJohn, imageUrl="https://smp.vgc.no/v2/images/bafa0544-7013-4f72-a167-23e409c10485?fit=crop&h=435&w=652&s=8d721fd5084ff21e67cf253f19320df0dfacdfd3")
  serieFriends.save()
  ...
  serieArrow.save()
  serieWitcher = Serie(name="The Witcher", rating=5.0, seasons=1, classification="TV-MA", director=directorSpielberg, imageUrl="https://occ-0-33-37.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABQYHuuRO8hPojbcDF-eNuU_PppZawwQPwA5e2GX9cNq6Cwa4B51pt1ynmeQmThZHZy6oieGg-jRbP0VdfSLO1O1N00eAY_tiez_lpEghlVr0ytaakKICyi7bZOGcfQ.jpg?r=382")
  serieWitcher.save()
  ...
  game.save()
  game = Videogame(title="Overwatch", classification="T", release_date="2016-05-24", rating=5.0, developer=developerBlizzard, imageUrl="https://www.educo.org/Educo/media/Imagenes/Blog/%C2%BFDebo-dejar-a-mis-hijos-jugar-con-Overwatch-portada-ok.jpg")
  game.save()
  game.genres.add(genreAction, genreShooter)
  game.save()
  ...
  game.save()
  game = Videogame(title="Assassins Creed: Odyssey", classification="M", release_date="2018-10-05", rating=5.0, developer=developerUbisoft, imageUrl="https://i.blogs.es/248355/1/450_1000.jpg")
  game.save()
  game.genres.add(genreAdventure, genreAction)
  game.save()
  game.consoles.add(consoleXboxOne, consolePS4)
  game.save()
  game = Videogame(title="Mario Kart 64", classification="E", release_date="1996-12-14", rating=5.0, developer=developerNintendo, imageUrl="https://www.nintenderos.com/wp-content/uploads/2018/10/mario-kart-64.jpg")
  game.save()
  game.genres.add(genreSport)
  game.save()
